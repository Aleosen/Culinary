...
export default function NavBar() {
  ...
  return (
    <nav className='relative z-50 max-h-15 bg-white shadow-lg' >
        <div className="w-screen md:max-w-screen mx-auto">
            <div className="flex justify-between items-center h-16 p-[10px]">
                ...
                <div className="hidden md:flex space-x-8 items-center">
                    ...
                    <Link
                    to="/add-recipe"
                    className="bg-green-500 text-white px-4 py-2 rounded-lg hover:opacity-70"
                    >
                    Добавить рецепт
                    </Link>
          ...
          className="fixed inset-0 z-50 bg-opacity-50"> {/* Затемнение */}
          <div className="fixed top-16 left-0 w-full bg-white z-50 shadow-lg"> {/* Белый фон + тень */}
